...
// 미니게임 통과 여부, 0이면 실패 1이면 성공
// 0부터 5까지 차례로 옷 입히기, 등교, 우유, 급식, 틀린그림찾기, 문제 풀기,
int clear[6] = { 2, 2, 2, 2, 2, 2 };
int clear_index = 0;
...
void init_is_wrong()
{
	...
	auto is_wrong_picnic = Object::create("/Images/picnic.png", is_wrong, 320, 155);
